...
signal changed(modifier: PrivateExportsCore.AccessModifier)
...
func set_modifier(new_modifier: PrivateExportsCore.AccessModifier):
...
func get_modifier() -> PrivateExportsCore.AccessModifier:
	return _modifier
